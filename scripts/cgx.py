...
# Last modified: 2025-02-14T08:05:23+0100
...
def read_mesh(name="all.msh"):
    ...
    Returns the nodes and elements and a node to element mapping as
    dictionaries, with the node or element numbers as the keys.  For the nodes
    the value is a 3-tuple of coordinate floats.  For the elements the value
    is a tuple of node numbers.
